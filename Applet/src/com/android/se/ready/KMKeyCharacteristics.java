...
public class KMKeyCharacteristics extends KMType {
  ...
  public short getEnforced(byte enforceType) {
    short arrPtr = getVals();
    return KMArray.cast(arrPtr).get(enforceType);
  }
/*
  ...
  public void setEnforced(short ptr, byte enforceType) {
    KMKeyParameters.cast(ptr);
    short arrPtr = getVals();
    KMArray.cast(arrPtr).add(enforceType, ptr);
