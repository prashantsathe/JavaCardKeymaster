...
public class KMAndroidSEApplet extends KMKeymasterApplet implements OnUpgradeListener {
	...
	private static KMAndroidSEApplet instance;
	
	public static KMAndroidSEApplet getInstance() {
		if(instance == null) {
			instance = new KMAndroidSEApplet(); 
		}
		return instance;
	}
	
  KMAndroidSEApplet() {
    super(KMAndroidSEProvider.getInstance());
  }
  ...
  public static void install(byte[] bArray, short bOffset, byte bLength) {
    getInstance().register(bArray, (short) (bOffset + 1), bArray[bOffset]);
  }
