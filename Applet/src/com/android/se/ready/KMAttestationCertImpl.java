...
import com.android.se.ready.KMAESKey;
import com.android.se.ready.KMByteBlob;
import com.android.se.ready.KMECPrivateKey;
import com.android.se.ready.KMMasterKey;
...
public class KMAttestationCertImpl implements KMAttestationCert {
  ...
  public static final byte[] X509SubjectKeymaster = {
  ...
  public KMAttestationCert subject(short obj) {
    subject = obj;
    return this;
  }
  ...
  private static void pushTbsCert(boolean rsaCert) {
    ...
    // issuer - der encoded
    pushBytes(
        KMByteBlob.cast(subject).getBuffer(),
        KMByteBlob.cast(subject).getStartOff(),
        KMByteBlob.cast(subject).length());
    pushValidity();
    // issuer - der encoded
    pushBytes(
