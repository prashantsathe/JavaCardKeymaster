...
import com.android.se.ready.KMAttestationKey;
import com.android.se.ready.KMECPrivateKey;
import com.android.se.ready.KMError;
import com.android.se.ready.KMException;
import com.android.se.ready.KMHmacKey;
import com.android.se.ready.KMMasterKey;
import com.android.se.ready.KMPreSharedKey;
...
public class KMAndroidSEProvider implements KMSEProvider {
  ...
  private static KMAndroidSEProvider androidSEProvider;

  public static KMAndroidSEProvider getInstance() {
	  if(androidSEProvider == null) {
		  androidSEProvider = new KMAndroidSEProvider();
	  }
    return androidSEProvider;
  }

  private KMAndroidSEProvider() {
